...
(2,'A félelem forrása a jövőben van, s aki megszabadul a jövőtől, annak nincs félnivalója.',2),
(3,'A tolerancia bűn, ha a gonosz megtűrését jelenti.',3),
(4,'Az ember gyorsan beletanul abba, aminek belsőleg szükségét érzi.',3),
(5,'A művészet fölfokozott élet. Mélyebben boldogít, gyorsabban fölemészt.',4),
...
(14,'Mindenek fölött Légy hű magadhoz: így, mint napra éj, Következik, hogy ál máshoz se léssz.',10),
...
(17,'Az ember akkor fedezi föl magát, amikor megmérkőzik az akadállyal.',13),
(18,'Szeretni nem annyit jelent, mint egymás szemébe nézni, hanem azt jelenti: együtt nézni ugyanabba az irányba.',13),
(19,'Mert magamat kigúnyolom, ha kell, De hogy más mondja, azt nem tűröm el!',14),
